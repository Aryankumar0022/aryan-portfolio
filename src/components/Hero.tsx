...
const socials = [
  ...
  {
    name: "Email",
    href: "mailto:hello@aryankumar.dev",
    icon: (
      ...
      <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-14 items-center">
        ...
        <div className="order-2 md:order-1 text-center">
          ...
          >
            ...
            Kumar
            <br />
            <span className="text-muted italic text-[1.8rem] md:text-[2.4rem]">
          ...
          <motion.p
            ...
            className="mt-6 max-w-[440px] mx-auto text-[15px] text-muted leading-[1.8]"
          >
