...
const socials = [
  {
    name: "GitHub",
    href: "https://github.com/Aryankumar0022",
    icon: (
  ...
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/aryan-kumar-0a54aa2a5/",
    icon: (
      <svg className="w-[20px] h-[20px]" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-14 items-center">
        ...
        <div className="order-2 md:order-1 text-center">
          ...
          <motion.h1
            ...
            className="font-sans text-[2.6rem] md:text-[3.4rem] leading-[1.1] tracking-tight font-medium text-ink"
          >
            <span
          ...
          {/* Social icons — horizontal row below buttons */}
          <motion.div
            initial={{ opacity: 0, y: 8 }}
            animate={{ opacity: 1, y: 0 }}
