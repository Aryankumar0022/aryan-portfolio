  ...
  return (
    <section id="contact" className="py-10 md:py-14">
      ...
      <div className="text-center">
        ...
        <FadeIn delay={0.05}>
          <p className="text-[20px] leading-[1.85] text-muted max-w-[520px] mx-auto mb-10">
        ...
        <FadeIn delay={0.1}>
          <div className="flex flex-wrap items-center justify-center gap-5 mb-10">
            ...
            <a
              ...
              className="group flex items-center h-[60px] glass-card rounded-[30px] px-[18px] transition-all duration-500 ease-out hover:px-6 hover:shadow-lg hover:-translate-y-1 hover:border-accent/40"
            >
              ...
              <span className="max-w-0 overflow-hidden opacity-0 group-hover:max-w-[240px] group-hover:opacity-100 group-hover:ml-3 transition-all duration-500 ease-out font-sans font-medium whitespace-nowrap text-ink">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group flex items-center h-[60px] glass-card rounded-[30px] px-[18px] transition-all duration-500 ease-out hover:px-6 hover:shadow-lg hover:-translate-y-1 hover:border-[#E1306C]/40"
            >
